...
public class MapEventsActivity extends AppCompatActivity implements OnMapReadyCallback,
        GoogleApiClient.ConnectionCallbacks,GoogleMap.OnCameraMoveStartedListener,GoogleMap.OnMapLoadedCallback,
        GoogleApiClient.OnConnectionFailedListener,GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnCameraIdleListener,
        LocationListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTapTextView= (TextView) findViewById(R.id.idEvents);
    ...
    private void accessMap() {
        ...
        if (hasWriteStoragePermission != PackageManager.PERMISSION_GRANTED) {
            ...
            if (showRequestAgain) {
                new AlertDialog.Builder(MapEventsActivity.this).setMessage("Map requires access location permission")
                        .setPositiveButton("ALLOW", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(MapEventsActivity.this, new String[]{PERMISSION_ACCESS_FINE_LOCATION},
                ...
                ActivityCompat.requestPermissions(MapEventsActivity.this, new String[]{PERMISSION_ACCESS_FINE_LOCATION}, REQUEST_CODE_ACCESS_FINE_LOCATION);
                return;
            }
        }
        showMap();
    ...
    public void onCameraIdle() {
        mTapTextView.setText(googleMap.getCameraPosition().toString());
    }
